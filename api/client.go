...
func (cli *DockerCli) CmdBuild(args ...string) error {
	...
	noCache := &noCacheFlag{}
	cmd.Var(noCache, []string{"#no-cache", "-no-cache"}, "Do not use cache when building the image. Optionally takes a string to use as a POSIX ERE regexp to disable cache for matched RUN and ADD commands")
